            ...
            <Col lg={6} md={6} className="text-center">
              <nav className="hidden lg:block">
                <ul className="flex justify-center space-x-10">
                  ...
                  <li><a href="./shop.html" className="text-black font-semibold text-lg relative hover:after:scale-100 after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-red-500 after:transform after:scale-x-0 after:transition-transform">Shop</a></li>
